    ...
    <aside class="left-sidebar"> <!-- COLOR == | Fondo Barra Lateral Izquierdo | ==-->
        ...
        <div>
            ...
            <div class="brand-logo d-flex align-items-center justify-content-between">
                <a href="./index_organ.jsp" class="text-nowrap logo-img">
            ...
            <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
                <ul id="sidebarnav">
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="./index_organ.jsp" aria-expanded="false">
                <span>
                  <i class="ti ti-layout-dashboard"></i>
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="./organizations_events.jsp" aria-expanded="false">
                <span>
                  <i class="ti ti-calendar-event"></i>
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="./organizations_surveys.jsp" aria-expanded="false">
                <span>
                  <i class="ti ti-clipboard-text"></i>
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="./organizations_postulates.jsp" aria-expanded="false">
                <span>
                  <i class="ti ti-man"></i>
                </span>
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="./organizations_aprob.jsp" aria-expanded="false">
                <span>
                  <i class="ti ti-check"></i>
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="./organizations_porfile.jsp" aria-expanded="false">
                <span>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end dropdown-menu-animate-up" aria-labelledby="drop2">
                                ...
                                <div class="message-body">
                                    <a href="./organizations_porfile.jsp" class="d-flex align-items-center gap-2 dropdown-item">
